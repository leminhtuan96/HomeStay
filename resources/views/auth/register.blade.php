...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('Login_v8/fonts/font-awesome-4.7.0/css/font-awesome.min.css') }}">
    <!--===============================================================================================-->
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <form class="login100-form validate-form p-l-55 p-r-55 p-t-178 p-b-40" method="post">
                    ...
                    <div class="wrap-input100 validate-input m-b-50" data-validate="Please confirm password">
